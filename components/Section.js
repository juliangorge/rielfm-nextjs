...
export default function Section({params}) {
	...
	const items = params.items,
		  ...
		  path = 'https://rielfm.com.ar/' + section.class,
		  itemsPerPage = 10,
	...
	return (
        <>
			<SeoMetaTags params={{
				type: 'section',
				title: section.name + ' - FM Riel',
				section: section.name,
				description: 'Toda la información sobre ' + section.name,
				path: path,
				image: 'https://rielfm.com.ar/img/og-images/' + section.class + '.png'
			}} />
